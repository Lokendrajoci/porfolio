...
export default function Navbar() {
  ...
  return (
    <div className="w-full bg-red-800 flex justify-center px-4 sm:px-6">
      <nav
        className={`${
          poppins.className
        } fixed top-0 z-50 transition-all duration-300 w-full max-w-3xl mt-3
      ...
      >
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link
              href="/"
              className={`text-lg sm:text-xl font-bold ${roboto.className} text-white transition-colors duration-300 hover:text-[#60a5fa]`}
            >
              My Portfolio
            </Link>
